module.directive("datetime",function(){
    return {
        ...
        controller: ['$scope', '$element', '$document', '$compile', '$interval', 'datetimeService', function($scope,$element,$document,$compile,$interval,datetimeService){
...
module.directive('datetimeTpl', function() {
    return {
        ...
        controller: ['$scope', '$element', '$timeout', '$interval', '$document', 'datetimeService', function($scope,$element,$timeout,$interval,$document,datetimeService) {
