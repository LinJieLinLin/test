module.exports = function(grunt) {
  ...
  grunt.initConfig({
    srv: {
      ...
      igsrv: {
        ...
        ucmd: ws_b_dir + '/bin/ars :7981',
        wcmd: ws_b_dir + '/bin/ars :7981',
      },
      jcr: {
        options: {
          stdout: true,
  ...
  grunt.registerTask('d_srv', ['srv:wdm', 'srv:igsrv', 'srv:jcr']);
  grunt.registerTask('w_srv', ['srv:wdm', 'srv:igsrv', 'srv:jcr', 'srv-wait']);
