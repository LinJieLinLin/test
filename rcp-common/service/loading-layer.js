    ...
    win.loadingLayer = (function (){
        ...
        (function (){
            win.loadingLayerStyleText = [
                ...
                '.loading-circle{position:absolute;left:50%;top:50%;display:block;width:35px;height:35px;margin:-20px 0 0 -20px;border:5px solid rgba(0,0,0,.5);border-top-color:white;border-radius:50%;}',
        ...
        Loading.fn.in = function (){
            var id = doc.querySelector('#loading-layer');
            if(id){
                node.d = id;
                node.i = {};
                return;
