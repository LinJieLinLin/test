...
if (!module) {
 ...
 module.run(['$rootScope', 'service', function ($rootScope, service){
...
(function (){
    ...
    function prev(){
        page--;
        page = page < 0 ? (item.length-1) : page;
        change(page);
    }
    function clearTimer(){
        clearInterval(timer);
