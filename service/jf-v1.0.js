...
(function (win,doc){
			...
			forEvent : function (attr,str,opts,callback,callwith,defineCallback,cancelCallback){
				...
				if(defineCallback){
					html = '<div class="jf-drag">'+
							  '<div class="jf-tips-h"><b>'+ (opts.confirmTitle || '操作确认') +'</b><a href="javascript:;" class="jf-tips-cancel">X</a></div>'+
							  '<div class="jf-tips-c">'+str+'</div>'+
							  '<div class="jf-tips-f"><a href="'+ (opts.open ? opts.open+'" target="_blank"' : 'javascript:;"') +' class="jf-tips-define">确定</a><a href="javascript:;" class="jf-tips-cancel">取消</a></div>'+
						  '</div>';
				}
	...
	$('head').append(
		...
		'.jf-tips-h .jf-tips-cancel {text-indent:0;position:absolute;right:5px;top:2px;line-height:100%;padding:3px 5px;display:block;border-radius:3px;color:#b1b1b1;font:12px/1 "lucida Grande",Verdana,Arial;}'+
		'.jf-tips-h .jf-tips-cancel:hover { text-decoration: none;background:#ccc;color:white;text-shadow:-1px -1px 0 #c1c1c1;}'+
		'.jf-drag { cursor: move;}'+
